...
import { ERROR_MESSSAGE_MIN_LENGTH, ERROR_MESSAGE_MAX_LENGTH, ERROR_MESSAGE_INVALID_EMAIL, ERROR_MESSAGGE_IS_EMPTY, ERROR_MESSAGE_ALREADY_EXISTS,  } from "../constant";
